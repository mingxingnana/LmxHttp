...
public class HookInvocationHandler implements InvocationHandler {
    ...
    private String cls;
    private IntentLietener lietener;

    public HookInvocationHandler(Object amsObj, String packageName, String cls, IntentLietener lietener) {
        this.mAmsObj = amsObj;
...
//            if (originallyIntent.getComponent() != null && !originallyIntent.getComponent().getClassName().equals("com.tencent.mm.plugin.base.stub.WXPayEntryActivity"))

            if (lietener != null)
                if (lietener.hook(originallyIntent)) {
